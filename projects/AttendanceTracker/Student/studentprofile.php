...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    $profile_picture = $student['profile_picture']; // Keep existing picture by default
        ...
        if (!empty($current_password)) {
            ...
            if (password_verify($current_password, $student['password'])) {
                if ($new_password === $confirm_password) {
                    ...
                    $query = "UPDATE students SET full_name = ?, email = ?, password = ?, profile_picture = ? WHERE id = ?";
                    $stmt = $conn->prepare($query);
                    $stmt->bind_param("ssssi", $full_name, $email, $hashed_password, $profile_picture, $student_id);
                } else {
            ...
            $query = "UPDATE students SET full_name = ?, email = ?, profile_picture = ? WHERE id = ?";
            $stmt = $conn->prepare($query);
            $stmt->bind_param("sssi", $full_name, $email, $profile_picture, $student_id);
        }
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                            ...
                            value="<?php echo isset($student['student_id']) ? htmlspecialchars($student['student_id']) : ''; ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" 
                                   value="<?php echo isset($student['email']) ? htmlspecialchars($student['email']) : ''; ?>" required readonly>
                        </div>
